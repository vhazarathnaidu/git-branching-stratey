...
# -----------------------------
echo "================================================"
echo "Starting node creation process..."
echo "================================================"

read -p "How many agents/nodes you want to create? : " COUNT

echo "Total nodes selected : $COUNT"

for ((i=1;i<=COUNT;i++))
do

echo "------------------------------------------------"
echo "Creating node number $i"
echo "------------------------------------------------"

read -p "Enter node name : " NAME

echo "Node selected : $NAME"

read -p "Enter executors count for $NAME : " EXECUTORS

echo "Executors selected for $NAME : $EXECUTORS"

read -p "Enter label for $NAME : " LABEL

echo "Label selected for $NAME : $LABEL"
